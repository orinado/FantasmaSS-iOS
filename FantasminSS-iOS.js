...
var TRANSLATIONS = {
  ...
  en: {
    eyebrow: "iOS Scanner",
    credits: "by Fantasma @orinado · Juniormodz · Teca",
    fileLabel: "File:",
    start: "Start",
...
async function main() {
  ...
  if (type2 && type1 === type2) {
    ...
    a.message = type1 === "ndjson"
      ? "Los 2 archivos parecen ser Reportes de Privacidad de Apps. Selecciona un xp_amp_app_usage_dnu*.ips como segundo archivo."
  ...
  if (!validation.ok) {
    ...
    a.message = validation.reason + "\n\nExpórtalo en: Ajustes → Privacidad → Reporte de Privacidad de las Apps → Exportar"
    a.addAction("OK")
    await a.present()
    return
  }
